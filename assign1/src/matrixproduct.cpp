...
// Basic multiplication algorithm for matrices implementation: 
...
// Line multiplication algorithm for matrices implementation: 
...
// Block multiplication algorithm for matrices implementation: 
void OnMultBlock(int m_ar, int m_br, int bkSize)
{
	...
	{	
		...
		{	
			for (i=0; i<m_ar; i++)
			{
				for (k=l; k<min(bkSize+l,m_ar); k++)
				{
					for (j=m; j<min(bkSize+m,m_br); j++)
					{
						phc[i*m_ar+j] += pha[i*m_ar+k] * phb[k*m_br+j];
					}
				}	
